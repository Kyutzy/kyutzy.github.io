...
function pokemonDraw(){
    ...
    ctx_pokemon.drawImage(foto,60,50,400,400)
    console.log("feito")
    ...
    "648":"Meloetta",
    "649":"Genesect",}
    ctx_pokemon.font = "bold 48px arial"
    ctx_pokemon.textAlign = "center"
    ctx_pokemon.fillText(pokemons[pokedex], canvas_pokemon.width/2, 50)
    });
}
...
function timer(){
  ...
  var ctx_pokemon = canvas_pokemon.getContext("2d")
  ctx_pokemon.font = "bold 48px arial"
  ctx_pokemon.clearRect(0,0,100, 100)
  ctx_pokemon.fillText(timeRunning, 40, 50)
...
function countdown(){
  ...
  if(timeRunning <= 0){
    ...
    document.getElementById("comecar").style.opacity = 1
...
function start(){
  ...
  document.getElementById("comecar").style.opacity = 0
  document.getElementById("comecar").disabled = true
  timeRunning = 45
  timerRun = true
  pokemonDraw()
  window.intervalo = setInterval(countdown, 1000)
}
